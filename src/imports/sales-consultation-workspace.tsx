...
[SCREEN]
Design Consultation Workspace for IDAS sales users.

[GOAL]
This screen must be the main working space for sales consultations and the launch point for configurator, compare, quote, and test drive actions.

[ENTRY]
Opened from Today's Consultations Queue or Lead/Opportunity detail.

[SECTIONS]
- customer context
- vehicle interest / target model
- consultation notes
- next best action
- linked tools

[TOOLS INSIDE WORKSPACE]
- 3D Configurator
- Compare
- Quotation Builder
- Test Drive Booking
...
- suggest vehicle/package based on interest

[LAYOUT]
- Tablet-first
- workspace-centered
- optional immersive mode when opening configurator

[OUTPUT FILE]
app/sales/consultation/[id]/page.tsx