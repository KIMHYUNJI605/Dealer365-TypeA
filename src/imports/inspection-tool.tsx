...
[SCREEN]
Create DVI / MPI Inspection Tool for technicians.

[GOAL]
Technicians must inspect the vehicle, mark findings, attach media, and generate customer-facing VHC recommendations.

[DEVICE RULE]
Technician UI is mobile-first.
...
[REQUIREMENTS]
- support categories (brakes / tires / fluids / battery / etc.)
- photo/video attachment
- annotations
- parts/labor estimate hooks
- recommendation summary generation

[OUTPUTS]
- internal DVI/MPI record
- customer-facing VHC
- approval request package

[AI SUPPORT]
- summarize findings
- suggest recommended repair packages
...
[OUTPUT FILE]
app/service/inspection/[id]/page.tsx